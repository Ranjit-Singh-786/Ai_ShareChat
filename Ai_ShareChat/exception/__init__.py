import sys
class ShareChatException(Exception):
    def __init__(self, error_message:Exception, error_detail:sys):
        super().__init__(error_message)
        self.error_message = ShareChatException.error_message_detail(error_message,error_detail=error_detail)
    ...
    def __str__(self):
        return ShareChatException.__name__.__str__()